...
const config: Config = {
    title: 'SparkFun 2D Barcode Scanner Breakout Documentation',
    tagline: 'Scan and interpret all kinds of barcodes with the SparkFun 2D Barcode Scanner Breakout',
    ...
    baseUrl: '/2D_Barcode_Scanner_Breakout/',

    // GitHub pages deployment config.
    // If you aren't using GitHub pages, you don't need these.
    organizationName: 'sparkfun', // Usually your GitHub org/user name.
    projectName: '2D_Barcode_Scanner_Breakout', // Usually your repo name.
    ...
    themeConfig: {
        ...
        docsearch: {
            ...
            searchParameters: {
                facetFilters: ['section:2D_Barcode_Scanner_Breakout'],
            },
        ...
        navbar: {
            title: 'SparkFun 2D Barcode Scanner Breakout Hookup Guide',
            logo: {
                alt: 'SparkFun Logo',
            ...
            items: [
                ...
                // },
                {
                    href: 'https://github.com/sparkfun/2D_Barcode_Scanner_Breakout',
                    position: 'right',
        ...
        footer: {
            ...
            links: [
                {
                    title: '2D Barcode Scanner Breakout Board (V2)',
                    items: [
                        {
                            label: '2DBarcodeScannerv2',
                            href: 'https://www.sparkfun.com/sparkfun-2d-barcode-scanner-breakout-v2.html'
                        },
                    ],
                },
                {
